...
- checkout all updates
  here [Changelog 1.19-Forge](https://github.com/tristankechlo/ToolLeveling/blob/1.19-Forge/Changelog.md#version-1193---144)
...
- change when the buttons are clickable
    - buttons for disabled enchantments are now actually disabled, this was not the case for useless enchantments like
      mending
