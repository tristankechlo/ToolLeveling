...
public class ModRegistry {
    ...
    public static final RegistryObject<ContainerType<ToolLevelingTableContainer>> TLT_CONTAINER = CONTAINER_TYPES.register(Names.TABLE, () -> IForgeContainerType.create(ToolLevelingTableContainer::createForClientSide));

    public static final RegistryObject<TileEntityType<ToolLevelingTableTileEntity>> TLT_TILE_ENTITY = TILE_ENTITIES.register(Names.TABLE, () -> TileEntityType.Builder.of(ToolLevelingTableTileEntity::new, TLT_BLOCK.get()).build(null));
}
