...
public class ChestContents implements IInventory {
	 ...
	 * 
	 * @param size                           the max number of ItemStacks in the
	 *                                       inventory
	 * @param canPlayerAccessInventoryLambda the function that the container should
	 *                                       call in order to decide if the given
	 *                                       player can access the container's
	 *                                       contents not. Usually, this is a check
	 *                                       to see if the player is closer than 8
	 *                                       blocks away.
	 * @param markDirtyNotificationLambda    the function that the container should
	 *                                       call in order to tell the parent
	 *                                       TileEntity that the contents of its
	 *                                       inventory have been changed and need to
	 *                                       be saved. Usually, this is
